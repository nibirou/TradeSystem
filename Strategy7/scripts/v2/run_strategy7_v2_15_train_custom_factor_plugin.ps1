...
$outputDir = Join-Path $repoRoot "Strategy7\outputs\smoke_v2\run_strategy7_15_train_custom_factor_plugin"
...
conda run -n env_quant --no-capture-output python .\Strategy7\run_strategy7.py `
  ...
  --factor-list "custom_ret_accel_5_20,breakout_20,amihud_20" `
