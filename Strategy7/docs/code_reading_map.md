...
5. 深度选股模型入口统一在 `strategy7/models/stock_selection/factory.py`；FactorGCL、DAFAT、DFQ-TimesNet、DTLC_RL、StockFormer 分别对应 `factor_gcl_model.py`、`dafat_transformer_model.py`、`dfq_timesnet_model.py`、`dtlc_rl_model.py`、`stockformer_model.py`
